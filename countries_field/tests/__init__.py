...
from tools.countries_field.fields import CountriesValue
from tools.countries_field.tests.models import TestCountriesModel
...
class CountriesFieldTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        settings.INSTALLED_APPS.append("tools.countries_field.tests")
